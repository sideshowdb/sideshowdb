//! Integration tests for the ziggit-backed `RefStore`. Drives the store
//! through the shared parity harness plus a metacharacter-literal history
//! check that captures backend-specific path-matching behavior.
